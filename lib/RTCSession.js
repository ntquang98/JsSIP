...
module.exports = class RTCSession extends EventEmitter
{
  ...
  terminate(options = {})
  {
    ...
    switch (this._status)
    {
      ...
      case C.STATUS_1XX_RECEIVED:
        ...
        {
          return new TypeError(`Invalid status_code: ${status_code}`);
        }
        else if (status_code)
        {
  ...
  _createLocalDescription(type, constraints)
  {
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        // Resolve right away if 'pc.iceGatheringState' is 'complete', and iceRestart has not explicltly been requested in constraints.
        ...
        if (connection.iceGatheringState === 'complete' && constraints.iceRestart) {
          debug('iceGatherState is complete, but iceRestart is explicltly requested');
        }
