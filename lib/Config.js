...
const checks = {
  ...
  optional : {
    ...
    set_registration_timeout(set_registration_timeout)
    {
      if (typeof set_registration_timeout === 'boolean')
      {
        return set_registration_timeout;
      }
    }
  }
};
